				...
				*/
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Title Event</label>
                            <div class="col-sm-12 col-md-10">
						 ...
						 <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Date of the Event</label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-10 offset-md-2">
                                <button type="submit" class="btn btn-primary" name=" ">Add Event</button>
                            </div>
                        </div>
                    </form>
                </div>
