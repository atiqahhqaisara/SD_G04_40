			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<ul class="submenu">
						...
						<li><a href="http://localhost/Dashboard-Staff/Promotions.php">Edit Promotions</a></li>
						<li><a href="">Delete Events</a></li>
			...
			<div class="min-height-200px">
				...
				*/
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Add Ticket Price</h4>
                            <p class="mb-30">Add new ticket price</p>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                            	<select class="form-control" name=" " required>
                            		<option value=" " selected>Malaysian</option>
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                            	<select class="form-control" name=" " required>
                            		...
                            		<option value=" " selected>Senior Citizen</option>
                            	</select>
                            </div>
                        </div>   
						 ...
						 <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name=" " required placeholder="RM">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-10 offset-md-2">
                                <button type="submit" class="btn btn-primary" name=" ">Add Ticket Price</button>
                            </div>
                        </div>
                    </form>
                </div>
