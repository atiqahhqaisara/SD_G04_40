			...
			<div class="min-height-200px">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                            <a href='viewBooking.php?bookingId=" . $row["bookingId"] . "' class='btn btn-info btn-sm'>View</a>
                            <a href='editBooking.php?bookingId=" . $row["bookingId"] . "' class='btn btn-info btn-sm'>Edit</a>
                            <a href='deleteBooking.php?bookingId=" . $row["bookingId"] . "' class='btn btn-info btn-sm'>Delete</a>
                        </td>";
