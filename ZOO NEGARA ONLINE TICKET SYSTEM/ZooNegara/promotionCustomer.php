...
<html>
<head>
<title>Zoo Negara | Promotion</title>
...
<div id="event">
  <div id="header"> <a href="homepage.php" id="logo"><img src="images/header_logo_Zoo_Negara.png" alt="headerLogo" height = 230/></a>
    ...
    <ul id="navigation">
                ...
                <li id="link3" class="selected"><a href="promotionCustomer.php">Promotion</a></li>
  ...
  <div id="contentEvent">
    <div id="events">
      ...
      while ($row = mysqli_fetch_assoc($result)) {
          echo '<li>';
          echo '<div><a href="#"><img src="../Dashboard/promotion/' . $row['image'] . '" alt=""/></a></div>';
          echo '<h4><a href="#">' . $row['promotionName'] . '</a></h4>';
          echo '<p>Date: ' . $row['promotion'] . ' - ' . $row['lastDate'].'</p>';
  ...
  <div id="footer">
    <div> <a href="#" class="logo"><img src="images/capybaraFooter.png" alt=""/></a>
     ...
     <ul class="navigation">
      ...
      <p><br>Copyright &copy; <a href="#">Zoo Negara 2023</a> - All Rights Reserved | <a target="_blank" href="homepage.php">zoonegaramalaysia.my</a></p>
    </div>
  </div>
</div>
</body>
