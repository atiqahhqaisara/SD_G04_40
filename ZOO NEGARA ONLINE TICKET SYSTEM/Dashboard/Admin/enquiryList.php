	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				$sql = "SELECT `enquiryId`, `email`, `phone`, `message`, `status` FROM enquiry";
				$result = $con->query($sql);

				if ($result->num_rows > 0) {
					echo "<div class='card-box mb-30'>";
					echo "<div class='pd-20'>";
					echo "<h4 class='text-blue h4'>Enquiry List</h4>";
					echo "</div>";
					...
					echo "<th class='table-plus datatable-nosort'>Enquiry Id</th>";
					echo "<th class='table-plus datatable-nosort'>Email</th>";
					echo "<th class='table-plus datatable-nosort'>Phone</th>";
					...
					while ($row = $result->fetch_assoc()) {
						echo "<tr>";
						echo "<td class='table-plus'>" . $rowNumber . "</td>";
