				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Ticket Price</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="bookingList.php">Ticket Price List</a></li>
									<li class="breadcrumb-item active" aria-current="page">View Ticket Price</li>
								</ol>
							</nav>
						</div>
					</div>
                    ...
                    if (mysqli_num_rows($query_run) > 0) {
                        ...
                        <form method="POST">
                            ...
                            <div class="pd-20 card-box mb-30">
                                <div class="clearfix">
                                    <div class="pull-left">
                                        <h4 class="text-blue h4">View Ticket Price</h4>
                                        <p class="mb-30">View ticket price information</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Ticket Id</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="number" name="ticketId" value="<?= $ticket['ticketId']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Visitor</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="text" name="visitor" value="<?= $ticket['visitor']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Category</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="text" name="category" value="<?= $ticket['category']; ?>"readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Price</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="number" name="price" value="<?= $ticket['price']; ?>"readonly>
                                    </div>
                                </div>
                               
                                <div class="form-group row">
                                    <div class="col-sm-12 col-md-10 offset-md-2">
                                    <button type="button" onclick="window.location.href='ticketList.php'" class="btn btn-primary">
                                           Back
                                        </button>
                                    </div>
                                </div>
