    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <!-- Add Contact Button -->
						<button class="btn btn-primary" data-toggle="modal" data-target="#addContactModal">Add Contact</button>
                    </div>
                </div>
            </div>
            <?php
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<h4 class='text-blue h4'>Contact List</h4>";
                echo "</div>";
                ...
                echo "<th class='table-plus datatable-nosort'>PIC Id</th>";
                echo "<th class='table-plus datatable-nosort'>PIC Name</th>";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='table-plus'>" . $row["picId"] . "</td>";
                    echo "<td class='table-plus'>" . $row["picName"] . "</td>";
                    echo "<td>
                            <button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#viewContact{$rowNumber}'>View</button>
                            <button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#editContact{$rowNumber}'>Edit</button>
                            <a href='deleteContact.php?picId=" . $row["picId"] . "' class='btn btn-info btn-sm'>Delete</a>
                        </td>";
                    echo "</tr>";
					echo '
						...
						<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="text-blue h4" id="addContactModalLabel">Add PIC</h4>
									...
									<form action="addContact.php" method="POST">
										<div class="form-group row">
											...
											<div class="col-sm-12 col-md-10">
												<input class="form-control" type="text" name="picName" required>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-12 col-md-2 col-form-label">Person In Charge Number</label>
											<div class="col-sm-12 col-md-10">
												<input class="form-control" type="number" name="picNum" required>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-12 col-md-2 col-form-label">Person In Charge Email</label>
											<div class="col-sm-12 col-md-10">
												<input class="form-control" type="text" name="picEmail" required>
											</div>
										</div>
										<div class="form-group row">
											<div class="col-sm-12 col-md-10 offset-md-2">
												<button type="submit" class="btn btn-primary" name="addPIC">Add PIC</button>
											</div>
										</div>
									</form>
								</div>
                    ...
                    echo "
                    <!-- View Contact Modal -->
                    <div class='modal fade' id='viewContact{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='viewContactModalLabel{$rowNumber}' aria-hidden='true'>
                        <div class='modal-dialog modal-lg modal-dialog-centered' role='document'>
                            <div class='modal-content'>
                                <div class='modal-header'>
                                <h4 class='text-blue h4' id='viewContactModalLabel{$rowNumber}'>View PIC</h5>
                                    <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                        <span aria-hidden='true'>&times;</span>
                                    </button>
                                </div>
                                <div class='modal-body'>
                                    <form method='POST' action='viewContact.php'>
                                        <input type='hidden' name='picId' value='{$row['picId']}'>
                                        
                                            <div class='form-group row'>
                                                <label class='col-sm-12 col-md-2 col-form-label'>Person in Charge Id</label>
                                                <div class='col-sm-12 col-md-10'>
                                                    <input class='form-control' type='number' name='picId' value='{$row['picId']}' readonly>
                                                </div>
                                            </div>
                                            <div class='form-group row'>
                                                <label class='col-sm-12 col-md-2 col-form-label'>Person in Charge Name</label>
                                                <div class='col-sm-12 col-md-10'>
                                                    <input class='form-control' type='text' name='picName' value='{$row['picName']}' readonly>
                                                </div>
                                            </div>
                                            <div class='form-group row'>
                                                <label class='col-sm-12 col-md-2 col-form-label'>Person in Charge Number</label>
                                                <div class='col-sm-12 col-md-10'>
                                                    <input class='form-control' type='number' name='picNum' value='{$row['picNum']}' readonly>
                                                </div>
                                            </div>
                                            <div class='form-group row'>
                                                <label class='col-sm-12 col-md-2 col-form-label'>Person in Charge Email</label>
                                                <div class='col-sm-12 col-md-10'>
                                                    <input class='form-control' type='email' name='picEmail' value='{$row['picEmail']}' readonly>
                                                </div>
                                            </div>
                                            <div class='form-group row'>
                                                <div class='col-sm-12 col-md-10 offset-md-2'>
                    ...
                    echo"
                    <!-- Edit Contact Modal -->
                    <div class='modal fade' id='editContact{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='editContactModalLabel{$rowNumber}' aria-hidden='true'>
                        <div class='modal-dialog modal-lg modal-dialog-centered' role='document'>
                            <div class='modal-content'>
                                <div class='modal-header'>
                                <h4 class='text-blue h4' id='editContactModalLabel{$rowNumber}'>Edit PIC</h5>
                                    <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                        <span aria-hidden='true'>&times;</span>
                                    </button>
                                </div>
                                <div class='modal-body'>
                                    <form action='editContact.php' method='POST'>
                                        ...
                                        <div class='form-group row'>
                                            <label class='col-sm-12 col-md-2 col-form-label'>Person In Charge Name</label>
                                            <div class='col-sm-12 col-md-10'>
                                                <input class='form-control' type='text' name='picName' value='{$row['picName']}'>
                                            </div>
                                        </div>
                                        <div class='form-group row'>
                                            <label class='col-sm-12 col-md-2 col-form-label'>Person In Charge Number</label>
                                            <div class='col-sm-12 col-md-10'>
                                                <input class='form-control' type='number' name='picNum' value='{$row['picNum']}'>
                                            </div>
                                        </div>
                                        <div class='form-group row'>
                                            <label class='col-sm-12 col-md-2 col-form-label'>Person In Charge Email</label>
                                            <div class='col-sm-12 col-md-10'>
                                                <input class='form-control' type='text' name='picEmail' value='{$row['picEmail']}'>
                                            </div>
                                        </div>
                                        <div class='form-group row'>
                                            <div class='col-sm-12 col-md-10 offset-md-2'>
