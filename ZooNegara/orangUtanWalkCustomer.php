...
<html>
<head>
<title>Zoo Negara | Events | ORANGUTAN FUN WALK</title>
...
<div id="page">
  <div id="header"><a href="index.php" id="logo"><img src="images/header_logo_Zoo_Negara.png" alt="headerLogo" height = 230/></a>
    ...
    <a href="buyTicketSignUp.php">Buy tickets</a>
    <ul id="navigation">
  ...
  <div id="content">
    <div id="events">
      <h1>ORANGUTAN FUN WALK</h1>
      <img src="images/orangUtan1.jpg" alt="infoOrangUtanWalk1" height = 430/>
      <img src="images/orangUtan2.jpg" alt="infoOrangUtanWalk2" height = 430/>
    </div>
  </div>
  <div id="footer">
