  ...
  <div id="content">
    <div id="info">
      ...
      <ul>
        ...
        <li>
          <h2><a href="#">Rides - Tram Rides</a></h2>
          <p>OKU - 10% discounted price <br>(Please show a valid OKU card)<br>
            Kids below 2 years old - FREE<br>
            Vip Booking - 1 hour, RM399.00</p>
        </li>
