    ...
    <div id="events">
      ...
      <ul>
        <li>
          ...
          <p><b>More information: </b><a href="birthdayPartyPackage.php">BIRTHDAY – ZOO FIESTA PARTY PACKAGE</a></p>
        </li>
        <li>
          ...
          <p>With a minimum commitment fees you will get a free entrance to Zoo Negara, fun activities, lucky draw, t-shirt, finisher medal, 2 meals (breakfast & lunch) and e-certificate.
            ...
            <br><b>More information: </b><a href = "orangUtanWalk.php">Orangutan Fun Walk</a>
          </p>
        </li>
        <li>
          ...
          <p><b>More information: </b><a href = "zooWalk2023.php">Zoo Walk 2023 Fun with NATURE</a>
        </li>
      </ul>
    </div>
  </div>
