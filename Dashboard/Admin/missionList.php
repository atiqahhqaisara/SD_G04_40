		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Mission List</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				if ($result->num_rows > 0) {
					...
					echo "<h4 class='text-blue h4'>Mission List</h4>";
					echo "</div>";
					...
					echo "<th class='table-plus datatable-nosort'>Mision Id</th>";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='table-plus'>" . $row["missionId"] . "</td>";
                        echo "<td>
						<button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#viewmissionModal{$rowNumber}'>View</button>
						<button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#editmissionModal{$rowNumber}'>Edit</button>
						<a href='deleteMission.php?missionId={$row["missionId"]}' class='btn btn-info btn-sm'>Delete</a>
						</td>";
						...
						echo "
						<!-- View mission Modal -->
						<div class='modal fade' id='viewmissionModal{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='viewmissionModalLabel{$rowNumber}' aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
										<h5 class='modal-title' id='viewmissionModalLabel{$rowNumber}'>View mission</h5>
									...
									<div class='modal-body'>
										...
										<form method='POST' action='viewMission.php'>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Mission Id</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='missionId' value='{$row['missionId']}' readonly>
												</div>
											</div>
											...
											<div class='form-group row'>
												...
												<div class='col-sm-12 col-md-10'>
													<textarea class='form-control' type='text' name='mission' readonly>{$row['mission']}</textarea>
												</div>
											</div>
						...
						echo "
						<!-- Edit mission Modal -->
						<div class='modal fade' id='editmissionModal{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='editmissionModalLabel{$rowNumber}' aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
										<h4 class='text-blue h4' id='editmissionModalLabel{$rowNumber}'>Edit mission</h4>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
