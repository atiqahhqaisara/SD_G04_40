	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				$sql = "SELECT * FROM admin WHERE position='STAFF'";
				$result = $con->query($sql);

				if ($result->num_rows > 0) {
					echo "<div class='card-box mb-30'>";
					echo "<div class='pd-20'>";
					echo "<h4 class='text-blue h4'>Staff List</h4>";
					echo "</div>";
					...
					echo "<tr>";
					echo "<th>No.</th>";
					echo "<th class='table-plus datatable-nosort'>Full Name</th>";
					...
					while ($row = $result->fetch_assoc()) {
						...
						echo "<td class='table-plus'>" . $row["fullName"] . "</td>";
						echo "<td class='table-plus'>" . $row["email"] . "</td>";
						echo "<td>
								<button type='button' class='btn btn-info btn-sm'
								data-toggle='modal' data-target='#viewStaff{$rowNumber}'>View</button>
								<button type='button' class='btn btn-info btn-sm'
								data-toggle='modal' data-target='#editStaff{$rowNumber}'>Edit</button>
								<a href='deleteStaff.php?email=" . $row["email"] . "' class='btn btn-info btn-sm'
								>Delete</a>
							</td>";

						echo "</tr>";
						// Staff View Modal for each row
						echo '
						<div class="modal fade" id="addStaffModal" tabindex="-1" role="dialog" aria-labelledby="addStaffModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="text-blue h4" id="addStaffModalLabel">Add Staff</h4>
						...
						echo "
						<!-- Staff View Modal -->
						<div class='modal fade' id='viewStaff{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='viewStaffModalLabel{$rowNumber}' aria-hidden='true'>
							<div class='modal-dialog modal-lg modal-dialog-centered' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
									<h4 class='text-blue h4' id='viewStaffModalLabel{$rowNumber}'>View Staff</h5>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
									<div class='modal-body'>
										<!-- Include the code for viewing staff details here -->
										<form method='POST' action='viewStaff.php'>
											<!-- Add any additional hidden fields if needed -->
											...
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Phone Number</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='number' name='phone' value='" . $row['phone'] . "' readonly>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Position</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='position' value='" . $row['position'] . "' readonly>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Address</label>
												<div class='col-sm-12 col-md-10'>
													<textarea class='form-control' readonly>" . $row["address"] . ", " . $row["postal"] . ", " . $row["district"] . ", " . $row["states"] . "</textarea>
												</div>
											</div>
						...
						// Staff Edit Modal for each row
						echo "
						<!-- Staff Edit Modal -->
						<div class='modal fade' id='editStaff{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='editStaffModalLabel{$rowNumber}' aria-hidden='true'>
							<div class='modal-dialog modal-lg modal-dialog-centered' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
									<h4 class='text-blue h4' id='editStaffModalLabel{$rowNumber}'>Edit Staff</h5>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
									<div class='modal-body'>
										...
										<form action='editBooking.php' method='POST'>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Full Name</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='fullName' value='" . (isset($row['fullName']) ? $row['fullName'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Phone Number</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='phone' value='" . (isset($row['phone']) ? $row['phone'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Email</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='email' name='email' value='" . (isset($row['email']) ? $row['email'] : '') . "' readonly>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Position</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='position' value='" . (isset($row['position']) ? $row['position'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Address</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='address' value='" . (isset($row['address']) ? $row['address'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Postal Code</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='number' name='postal' value='" . (isset($row['postal']) ? $row['postal'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>District</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='district' value='" . (isset($row['district']) ? $row['district'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>States</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='states' value='" . (isset($row['states']) ? $row['states'] : '') . "'>
												</div>
											</div>
											<div class='form-group row'>
												<div class='col-sm-12 col-md-10 offset-md-2'>
