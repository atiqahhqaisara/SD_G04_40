			...
			<div class="min-height-200px">
				...
				if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
						...
						echo "<td class='table-plus'>" . $row["eventName"] . "</td>";
                        echo "<td>
						<button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#viewEvent{$rowNumber}'>View</button>
							...
							<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="text-blue h4" id="addEventModalLabel">Add Event</h4>
						...
						<div class='modal fade' id='viewEvent{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='viewEventModalLabel{$rowNumber}'
							...
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
									<h4 class='text-blue h4' id='viewEventModalLabel{$rowNumber}'>View Event</h5>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
									<div class='modal-body'>
										...
										<form method='POST' action='viewEvent.php'>
											...
											<div class='form-group row'>
												...
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='number' name='eventId'
						...
						<div class='modal fade' id='editEvent{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='editEventModalLabel{$rowNumber}'
							...
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
										<h4 class='text-blue h4' id='editEventModalLabel{$rowNumber}'>Edit Event</h4>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
