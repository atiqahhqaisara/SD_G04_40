							...
							if ($_SERVER["REQUEST_METHOD"] == "POST") {
								...
								if (isset($_POST['selectedMonth']) && isset($_POST['selectedYear'])) {
									...
									if (!$result) {
										...
										// Calculate totals and total sales row by row
										while ($row = $result->fetch_assoc()) {
											...
											$totalSalesForRow = $row['grandTotal'];

											// Output or use $totalSalesForRow as needed for each row
							
											// Accumulate total sales
											$totalSales += $totalSalesForRow;
										}
									}
							...
							<div class="pb-20">
								<table class="table hover multiple-select-row data-table-export nowrap">
									<h5 class="h4 text-blue mb-20">
										<?php echo isset($selectedMonth) && isset($selectedYear) ? $selectedMonth . " " . $selectedYear : ""; ?>
									</h5>
									...
									<tbody>
										<tr>
											<td>
												<?php echo $myAdultTotal; ?>
											</td>
											<td>
												<?php echo $myChildTotal; ?>
											</td>
											<td>
												<?php echo $mySeniorTotal; ?>
											</td>
											<td>
												<?php echo $iAdultTotal; ?>
											</td>
											<td>
												<?php echo $iChildTotal; ?>
											</td>
											<td>
												<?php echo $iSeniorTotal; ?>
											</td>
											<td>
												<?php echo "RM " . $totalSales; ?>
											</td>
										</tr>
									</tbody>
								</table>
