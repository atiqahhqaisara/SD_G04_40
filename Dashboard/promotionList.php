			...
			<div class="min-height-200px">
				...
				if ($result->num_rows > 0) {
					...
					while ($row = $result->fetch_assoc()) {
						...
						echo "<a class='dropdown-item' href='editPromotion.php?promotionId=" . $row["promotionId"] . "'><i class=' fa fa-pencil'></i> Edit</a>";
						echo "<a class='dropdown-item' href='deletePromotion.php?promotionId=" . $row['promotionId'] . "'><i class='dw dw-delete-3'></i> Delete</a>";
						echo "</div>";
						echo "</div>";
						echo "</td>";
						echo "</tr>";
