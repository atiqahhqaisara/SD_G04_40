			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
                        ...
                        <!-- Add Contact Button -->
						<button class="btn btn-primary" data-toggle="modal" data-target="#addTicketModal">Add Ticket</button>
                    	</div>
					</div>
				</div>
				...
				if ($result->num_rows > 0) {
					...
					echo "<h4 class='text-blue h4'>Ticket List</h4>";
					echo "</div>";
                    ...
                    echo "<th class='table-plus datatable-nosort'>Ticket Id</th>";
					echo "<th class='table-plus datatable-nosort'>Category</th>";
					echo "<th class='table-plus datatable-nosort'>Price</th>";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='table-plus'>" . $row["ticketId"] . "</td>";
						echo "<td class='table-plus'>" . $row["visitor"] ." ". $row["category"]."</td>";
						echo "<td class='table-plus'>" . "RM ".$row["price"] . "</td>";
                        echo "<td>
							<button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#viewTicket{$rowNumber}'>View</button>
							<button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#editTicket{$rowNumber}'>Edit</button>

							<a href='deleteTicketPrice.php?ticketId=" . $row["ticketId"] . "' class='btn btn-info btn-sm'>Delete</a>
                        </td>";
							...
							<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="text-blue h4" id="addTicketModalLabel">Add Ticket Price</h4>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
									<div class="modal-body">
										<form action="addTicketPrice.php" method="POST">
											...
											<div class="form-group row">
												<label class="col-sm-12 col-md-2 col-form-label">Ticket Price</label>
												<div class="col-sm-12 col-md-10">
													<input class="form-control" type="number" name="price" required placeholder="RM">
												</div>
											</div>

											<div class="form-group row">
												<div class="col-sm-12 col-md-10 offset-md-2">
													<button type="submit" class="btn btn-primary" name="addTicket">Add Ticket Price</button>
												</div>
											</div>
										</form>
									</div>
						...
						echo "
						<!-- View Ticket Modal -->
						<div class='modal fade' id='viewTicket{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='viewTicketModalLabel{$rowNumber}' aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
									<h4 class='text-blue h4' id='viewTicketModalLabel{$rowNumber}'>View Ticket Price</h5>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
									<div class='modal-body'>
										...
										<form method='POST' action='viewTicket.php'> 
											...
											<div class='form-group row'>
												...
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='number' name='ticketId' value='{$row['ticketId']}' readonly>
												</div>
											</div>
											...
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Visitor</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='visitor' value='{$row['visitor']}' readonly>
												</div>
											</div>
											...
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Category</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='category' value='{$row['category']}' readonly>
												</div>
											</div>
											...
											<div class='form-group row'>
												...
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='number' name='price' value='{$row['price']}' readonly>
												</div>
											</div>
						...
						echo "
						<!-- Edit Ticket Modal -->
						<div class='modal fade' id='editTicket{$rowNumber}' tabindex='-1' role='dialog' aria-labelledby='editTicketModalLabel{$rowNumber}' aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
									<h4 class='text-blue h4' id='editTicketModalLabel{$rowNumber}'>Edit Ticket Price</h5>
										<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
											<span aria-hidden='true'>&times;</span>
										</button>
									</div>
									<div class='modal-body'>
										...
										<form action='editTicket.php' method='POST'>
											...
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Visitor</label>
												<div class='col-sm-12 col-md-10'>
													<input class='form-control' type='text' name='visitor' value='{$row['visitor']}''>
												</div>
											</div>
											<div class='form-group row'>
												<label class='col-sm-12 col-md-2 col-form-label'>Category</label>
