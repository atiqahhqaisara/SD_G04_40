			...
			<div class="min-height-200px">
				...
				*/
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Add Promotions</h4>
                      ...
                      <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Title Promotion</label>
                            <div class="col-sm-12 col-md-10">
						 ...
						 <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Date of the Promotion</label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-10 offset-md-2">
                                <button type="submit" class="btn btn-primary" name=" ">Add Promotion</button>
                            </div>
                        </div>
                    </form>
                </div>
